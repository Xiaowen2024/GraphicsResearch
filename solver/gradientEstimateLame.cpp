...
void solveGradientWOB( Vec2D x0,
   ...
   for (int i = 0; i < nWalks; i++) {
      ...
      Vec2D mu_at_y = getMixedConditionResultKernel7(y, boundaryDirichlet, boundaryNeumann, getDirichletValue, getNeumannValue, 14);
      ...
      Vec2D u_sample = matrixVectorMultiply(kelvin_kernel, mu_at_y);
...
int main( int argc, char** argv ) {
   string shape = "lame_wob_mixed_62";
   double h = 0.01;
